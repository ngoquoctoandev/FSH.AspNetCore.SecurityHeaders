...
public class CustomHeaderOptions
{
    ...
    public Dictionary<string, HeaderPolicyCollection> PolicyCollections { get; } = new();
    ...
    public HeaderPolicyCollection? GetPolicy(string name)
    {
        ...
        return PolicyCollections.TryGetValue(name, out var policyCollection) ? policyCollection : null;
    }
}