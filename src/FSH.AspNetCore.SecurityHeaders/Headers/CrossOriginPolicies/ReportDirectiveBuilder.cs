...
public class ReportDirectiveBuilder : CrossOriginPolicyDirectiveBuilderBase
{
    ...
    /// </summary>
    public ReportDirectiveBuilder() : base("report-to") => Endpoint = string.Empty;
    ...
    {
        if (string.IsNullOrWhiteSpace(endpoint)) throw new ArgumentException("Endpoint may not be null or empty", nameof(endpoint));
