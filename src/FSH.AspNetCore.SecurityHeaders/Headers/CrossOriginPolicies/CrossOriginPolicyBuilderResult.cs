...
namespace FSH.AspNetCore.SecurityHeaders.Headers.CrossOriginPolicies;
...
internal abstract class CrossOriginPolicyBuilderResult
{
    ...
    private class StaticCrossOriginPolicyBuilderResult : CrossOriginPolicyBuilderResult
    {
        ...
        /// </summary>
        /// <param name="constantValue">The constant value to use for all requests</param>
        public StaticCrossOriginPolicyBuilderResult(string constantValue) => ConstantValue = constantValue ?? throw new ArgumentNullException(nameof(constantValue));
