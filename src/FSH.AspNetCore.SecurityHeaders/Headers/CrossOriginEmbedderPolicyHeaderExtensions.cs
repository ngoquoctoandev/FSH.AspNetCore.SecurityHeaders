using FSH.AspNetCore.SecurityHeaders.Headers.CrossOriginPolicies.EmbedderPolicy;
...
public static class CrossOriginEmbedderPolicyHeaderExtensions
{
    ...
    public static HeaderPolicyCollection AddCrossOriginEmbedderPolicy(this HeaderPolicyCollection policies, Action<CrossOriginEmbedderPolicyBuilder> configure, bool asReportOnly = false) => policies.ApplyPolicy(CrossOriginEmbedderPolicyHeader.Build(configure, asReportOnly));
    ...
    /// <param name="configure">Configure the COEP</param>
    /// <returns>The <see cref="HeaderPolicyCollection" /> for method chaining</returns>
    public static HeaderPolicyCollection AddCrossOriginEmbedderPolicyReportOnly(this HeaderPolicyCollection policies, Action<CrossOriginEmbedderPolicyBuilder> configure) => policies.ApplyPolicy(CrossOriginEmbedderPolicyHeader.Build(configure, true));
}