...
public abstract class CrossOriginEmbedderPolicyHeader : HeaderPolicyBase
{
    ...
    protected CrossOriginEmbedderPolicyHeader(bool reportOnly) => ReportOnly = reportOnly;
    ...
    public class StaticCrossOriginEmbedderPolicyHeader : CrossOriginEmbedderPolicyHeader
    {
        ...
        public StaticCrossOriginEmbedderPolicyHeader(string value, bool asReportOnly) : base(asReportOnly) => _value = value;
