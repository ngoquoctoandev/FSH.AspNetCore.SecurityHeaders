...
internal abstract class CspBuilderResult
{
    ...
    /// </summary>
    /// <param name="hasPerRequestValues">
    ///     If true, the header directives are unique per request, and require
    ///     runtime formatting (e.g. for use with Nonce)
    /// </param>
    protected CspBuilderResult(bool hasPerRequestValues) => HasPerRequestValues = hasPerRequestValues;
    ...
    private class StaticCspBuilderResult : CspBuilderResult
    {
        ...
        /// </summary>
        /// <param name="constantValue">The constant value to use for all requests</param>
        public StaticCspBuilderResult(string constantValue) : base(false) => ConstantValue = constantValue ?? throw new ArgumentNullException(nameof(constantValue));

        /// <summary>
        ///     The CSP header value to use
        /// </summary>
        internal override string ConstantValue { get; }
    ...
    private class DynamicCspBuilderResult : CspBuilderResult
    {
        ...
        /// </summary>
        /// <param name="builder">A builder function to generate the directives for a given request</param>
        public DynamicCspBuilderResult(Func<HttpContext, string> builder) : base(true) => Builder = builder ?? throw new ArgumentNullException(nameof(builder));
        ...
        ///     A builder function to generate the directives for a given request
        /// </summary>
        internal override Func<HttpContext, string> Builder { get; }
    }
}