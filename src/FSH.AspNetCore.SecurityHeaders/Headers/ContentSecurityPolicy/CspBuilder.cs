...
public class CspBuilder
{
    ...
    private readonly Dictionary<string, CspDirectiveBuilderBase> _directives = new();
    ...
    internal CspBuilderResult Build()
    {
        ...
        if (!string.IsNullOrEmpty(constantDirective)) factories.Add(ctx => constantDirective);
