...
public static class CspDirectiveBuilderExtensions
{
    ...
    {
        if (string.IsNullOrWhiteSpace(uri)) throw new ArgumentException("Uri may not be null or empty", nameof(uri));
    ...
    {
        if (uris == null) throw new ArgumentException("Uris may not be null or empty", "uris");

        foreach (var uri in uris) builder.From(uri);
    ...
    /// <param name="hash">The hash for the source</param>
    /// <returns>The CSP builder for method chaining</returns>
    public static T WithHash256<T>(this T builder, string hash) where T : CspDirectiveBuilder => builder.WithHash("sha256", hash);
    ...
    /// <param name="hash">The hash for the source</param>
    /// <returns>The CSP builder for method chaining</returns>
    public static T WithHashSha384<T>(this T builder, string hash) where T : CspDirectiveBuilder => builder.WithHash("sha384", hash);
    ...
    /// <param name="hash">The hash for the source</param>
    /// <returns>The CSP builder for method chaining</returns>
    public static T WithHashSha512<T>(this T builder, string hash) where T : CspDirectiveBuilder => builder.WithHash("sha512", hash);
