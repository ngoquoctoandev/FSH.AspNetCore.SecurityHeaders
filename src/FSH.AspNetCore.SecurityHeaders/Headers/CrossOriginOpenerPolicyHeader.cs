...
public abstract class CrossOriginOpenerPolicyHeader : DocumentHeaderPolicyBase
{
    ...
    protected CrossOriginOpenerPolicyHeader(bool reportOnly) => ReportOnly = reportOnly;
    ...
    public class StaticCrossOriginOpenerPolicyHeader : CrossOriginOpenerPolicyHeader
    {
        ...
        public StaticCrossOriginOpenerPolicyHeader(string value, bool asReportOnly) : base(asReportOnly) => _value = value;
