using FSH.AspNetCore.SecurityHeaders.Headers.CrossOriginPolicies.OpenerPolicy;
...
public static class CrossOriginOpenerPolicyHeaderExtensions
{
    ...
    public static HeaderPolicyCollection AddCrossOriginOpenerPolicy(this HeaderPolicyCollection policies, Action<CrossOriginOpenerPolicyBuilder> configure, bool asReportOnly = false) => policies.ApplyPolicy(CrossOriginOpenerPolicyHeader.Build(configure, asReportOnly));
    ...
    /// <param name="configure">Configure the COOP</param>
    /// <returns>The <see cref="HeaderPolicyCollection" /> for method chaining</returns>
    public static HeaderPolicyCollection AddCrossOriginOpenerPolicyReportOnly(this HeaderPolicyCollection policies, Action<CrossOriginOpenerPolicyBuilder> configure) => policies.ApplyPolicy(CrossOriginOpenerPolicyHeader.Build(configure, true));
}