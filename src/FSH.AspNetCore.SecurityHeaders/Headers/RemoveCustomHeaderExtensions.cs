...
public static class RemoveCustomHeaderExtensions
{
    ...
    public static HeaderPolicyCollection RemoveCustomHeader(this HeaderPolicyCollection policies, string header) => policies.ApplyPolicy(new RemoveCustomHeader(header));
}