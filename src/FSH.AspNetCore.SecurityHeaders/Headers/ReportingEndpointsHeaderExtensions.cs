...
public static class ReportingEndpointsHeaderExtensions
{
    ...
    public static HeaderPolicyCollection AddReportingEndpoints(this HeaderPolicyCollection policies, Action<ReportingEndpointsHeaderBuilder> configure) => policies.ApplyPolicy(ReportingEndpointsHeader.Build(configure));
}