...
public static class XFrameOptionsHeaderExtensions
{
    ...
    public static HeaderPolicyCollection AddFrameOptionsDeny(this HeaderPolicyCollection policies) => policies.ApplyPolicy(new XFrameOptionsHeader("DENY"));
    ...
    /// <param name="policies">The collection of policies</param>
    /// <returns>The <see cref="HeaderPolicyCollection" /> for method chaining</returns>
    public static HeaderPolicyCollection AddFrameOptionsSameOrigin(this HeaderPolicyCollection policies) => policies.ApplyPolicy(new XFrameOptionsHeader("SAMEORIGIN"));
    ...
    /// <returns>The <see cref="HeaderPolicyCollection" /> for method chaining</returns>
    public static HeaderPolicyCollection AddFrameOptionsSameOrigin(this HeaderPolicyCollection policies, string uri) => policies.ApplyPolicy(new XFrameOptionsHeader($"ALLOW-FROM {uri}"));
}