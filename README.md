...
Install using the [FSH.AspNetCore.SecurityHeaders NuGet package](https://www.nuget.org/packages/FSH.AspNetCore.SecurityHeaders) from the Visual Studio Package Manager Console:

```
PM> Install-Package FSH.AspNetCore.SecurityHeaders
```

Or using the `dotnet` CLI

```bash
dotnet add package FSH.AspNetCore.SecurityHeaders
```
...
<Project Sdk="Microsoft.NET.Sdk.Web">
  ...
  <ItemGroup>
    <PackageReference Include="FSH.AspNetCore.SecurityHeaders" Version="0.3.7" />
  </ItemGroup>
...
<Project Sdk="Microsoft.NET.Sdk.Web">
  ...
  <ItemGroup>
    <PackageReference Include="FSH.AspNetCore.SecurityHeaders" Version="0.3.7" />
    <PackageReference Include="FSH.AspNetCore.SecurityHeaders.TagHelpers" Version="0.3.7" />
  </ItemGroup>
...
```csharp
@addTagHelper *, FSH.AspNetCore.SecurityHeaders.TagHelpers
```
